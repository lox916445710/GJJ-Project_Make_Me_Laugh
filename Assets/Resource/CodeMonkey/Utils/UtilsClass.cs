    ...
    public static class UtilsClass
    {
        ...
        public static float GetClipLength(this Animator animator, string clip)
        {
            ...
            for (int tCounter = 0, tLen = tAnimationClips.Length; tCounter < tLen; tCounter++)
            {
                ...
                {
                    Debug.Log(tAnimationClip.length);
        ...
        /// <summary>
        /// 获取目标对于参照物之间的角度，参数为目标和参照物和最终偏移
        /// </summary>
        /// <param name="referencePos"></param>
        /// <returns></returns>
        public static float GetAngle(Vector3 targetV3, Vector3 referencePos, float angleOffset)
        {

            float Angle = Mathf.Atan2(targetV3.y - referencePos.y, targetV3.x - referencePos.x) * Mathf.Rad2Deg;
